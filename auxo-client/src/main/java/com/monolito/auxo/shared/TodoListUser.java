...
public class TodoListUser implements User {
	...
	/**
	 * The name the user wants us to call them, both to themselves and other
	 * users.
	 */
	@NotNull
	@Size(min = 1, max = 60)
	...
	public String toString() {
		return StringFormat
				.format("TodoListUser: { loginName = '%s', shortName = '%s', fullName = '%s', email = '%s' }",
						loginName, shortName, fullName, email);
	}
}
