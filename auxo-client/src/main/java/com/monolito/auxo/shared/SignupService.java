...
public interface SignupService {
	 ...
	 *             if the signup is not possible (for example, disallowed
	 *             password; email address already in use; etc).
	 */
	TodoListUser register(TodoListUser newUserObject, String password)
			throws RegistrationException;
}
