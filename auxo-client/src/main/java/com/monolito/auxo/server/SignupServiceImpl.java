...
public class SignupServiceImpl implements SignupService {
	...
	@Override
	public TodoListUser register(TodoListUser newTodoListUser, String password)
		...
		identityManager
				.updateCredential(picketLinkUser, new Password(password));

		entityManager.persist(newTodoListUser);
		entityManager.flush();
		entityManager.detach(newTodoListUser);

		logger.info("Saved new user " + newTodoListUser + " (id="
				+ newTodoListUser.getEmail() + ")");
